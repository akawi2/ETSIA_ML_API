    ...
    for rec in recommendations:
        ...
        if post_data:
            formatted_rec = {
                'post_id': post_id,
                'score': rec['score'],
                'postcontent': post_data.get('postcontent'),
                'createdat': post_data.get('createdat'),
                'totallike': post_data.get('totallike'),
                'totalcomment': post_data.get('totalcomment'),
                'userid': post_data.get('userid'),
                'deletedat': post_data.get('deletedat'),
